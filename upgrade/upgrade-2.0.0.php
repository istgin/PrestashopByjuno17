...
function upgrade_module_2_0_0($module)
{
    ...
    $defaultStateId = $module->addOrderState("Awaiting for CembraPay", false);
    $receivedPaymentId = $module->addOrderState("CembraPay payment success", true, "#32CD32", true, true);
    $s4FailId = $module->addOrderState("CembraPay settle fail", false, "#FF0000", true, true);
    $s5FailId = $module->addOrderState("CembraPay refund fail", false, "#FF0000", true, true);
